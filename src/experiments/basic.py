...
class BasicExperiment(AuctionExperiment):
    ...
    def __init__(self):
        super(BasicExperiment, self).__init__("basic")
    ...
    def __default_param_set(self, mods = None):
        ...
        params = {
                ...
                'auction_class' : [LinearSubgradientAuction,
                                  ...
                                  # NOTE AdaptiveHeuristic is NOT the
                                  # cutting auction.  that needs to be
                                  # run with AdaptiveCuttingAuction
